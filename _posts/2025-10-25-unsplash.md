...
Pointing the cursor around the mapped areas lets me see what files are clustered. The huge, dark blue rectangle is the folder where Unsplash Wallpapers downloads images, which can be seen in the image above. Each little box is an individual file.
